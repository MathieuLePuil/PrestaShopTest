...
class appAppKernelProdContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'PrestaShop\\Module\\Psshipping\\Controller\\Admin\\ConfigurationController' => 'getConfigurationControllerService.php',
            ...
            'mbo.ps_eventbus.installer' => 'getMbo_PsEventbus_InstallerService.php',
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('jOfbo3K2g5', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = (new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))->createConnection(['driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => '', 'dbname' => 'prestashop', 'user' => 'root', 'password' => 'root', 'charset' => 'utf8mb4', 'driverOptions' => [1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))', 1013 => $this->getEnv('const:runtime:_PS_ALLOW_MULTI_STATEMENTS_QUERIES_')], 'defaultTableOptions' => []], new \Doctrine\DBAL\Configuration(), $a, ['enum' => 'string']);
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $e = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($d, [0 => (\dirname(__DIR__, 4).'/modules/psxdesign/src/Entity')]);
        $e->addExcludePaths([0 => (\dirname(__DIR__, 4).'/modules/psxdesign/src/Entity/index.php')]);
    ...
    {
        return $this->privates['api_platform.cache.identifiers_extractor'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('k6velxZNtR', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.property'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('URqRGWc9tf', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.property.legacy'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('rBqcAFFJtc', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('3y5J0xfXEV', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource.legacy'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('itzCL0f1s-', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource_collection'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('LZheSFZOM9', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.route_name_resolver'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('MRtmnmVYsk', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.subresource_operation_factory'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('5QGfTtKIKi', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('MtOxKcrE8z', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.property_access'] = \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('UA6UEHqlD-', 0, $this->getParameter('container.build_id'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.property_info'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('giJe3izOGJ', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('7p20HoXXPo', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.serializer'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('31rHb8YVzH', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.validator'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('sktpExMZb0', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(($this->privates['uri_signer'] ?? ($this->privates['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('fDxEUwhOFv4KmcbIkSqwjA6Cp1hObVGNXeVXYxMtcUX9v6GHIPRKZveiYTBvjuVo'))), '/_fragment');
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.active_modules' => [
                ...
                71 => 'ps_metrics',
                72 => 'graphnvd3',
                73 => 'ps_googleanalytics',
                74 => 'statsbestvouchers',
                75 => 'statsbestmanufacturers',
                76 => 'gsitemap',
                77 => 'statsstock',
                78 => 'ps_facetedsearch',
            ],
            ...
            'secret' => 'fDxEUwhOFv4KmcbIkSqwjA6Cp1hObVGNXeVXYxMtcUX9v6GHIPRKZveiYTBvjuVo',
            'ps_caching' => 'CacheMemcache',
            'ps_cache_enable' => false,
JIORcTndkmNWJs3uvd4gvGy1yF3QEFySYF7W6xUtaR1+EZrLVSK3UirMBVuksJv'."\n".'eutKKk8/bGJiQrRwtupBziSt+fFboERcbt6Arlt8GUECgYEA8kVJ+7AG4Fiw6eHb'."\n".'V6DUEQhJvmj0G5uzEy+tAME8J8x2wK66pnMWFQCDiYipnt1qoCMX2g2mIvyxSYO/'."\n".'DRS+CaC0qo+rZ0lwaUTmn5U7JrcY/n6hKtM+U4oBjgHKhJLo5bqp/lAgHsaEoJCs'."\n".'A1nv9nrTnIubWLmUC5jukvW/nH8CgYEA7oIcYa71h9W8fXUJILmQs57WFWjnSlcY'."\n".'klrZg2jN0Q+TvWmumyo01Yy8V66iOcLFMXTjb805h6J2FIRQDLvGZsLUQCy+ElKH'."\n".'DeCYXOvBPahgFxeeGS5pueokoiA0yGrYHROVwBaHatXK04ZyiJWLTWP7ZzqD8v1H'."\n".'GskEqmfHIzkCgYEAwbE70QmOtdayuopj/s8KPQPPUXg/kcMNjI1VV4EmQvtpBeus'."\n".'Nl9UjD347ABi/Cwxjw3/h8nZxacZZpj6Kc8nkDL3vlVWyCEiykbXy0ZYID/Kr801'."\n".'tTNmZQu06n/sFcoOgXyXZEdTJse4SVbg71z8SKcyf7nt3SWhgxQlyUDIjKkCgYAK'."\n".'/opqYlNFILAgpF14WbV24jKCKCTJQ3yJepCeQx2BrpMj3xRCaM6orWUdMZqeyQCo'."\n".'B/hX9gDZ5L5Gsdayz5EUuZRpJObaF13MYPcFCYUN344WYmtSQ9Zx0H5BzvQ/7NTr'."\n".'ejSj9yXk4dgIqiDrdOFH/vzexE7Cy7QUYwHJDSGb2QKBgQC/L8iarij9SEJ+ukmw'."\n".'UQRypMlZe77BtQavobDFz9qdpj3D34rLDO5li3RODzMh7bcQSPpk/3px/HpsLvZr'."\n".'gfQnpRqNAojvCrnfk0/Db2ARef785RKnTx36DMYfnwdfdGZCIoOXKHavX+zUmtNK'."\n".'EANuNsmPGe9qkPdbsl95KMhyDA=='."\n".'-----END PRIVATE KEY-----'."\n".'',
            'cache.driver' => 'array',
            ...
            'modules_translation_paths' => [
                ...
                22 => (\dirname(__DIR__, 4).'/modules/statscarrier/translations'),
                23 => (\dirname(__DIR__, 4).'/modules/pagesnotfound/translations'),
                24 => (\dirname(__DIR__, 4).'/modules/ps_wirepayment/translations'),
                25 => (\dirname(__DIR__, 4).'/modules/statspersonalinfos/translations'),
                26 => (\dirname(__DIR__, 4).'/modules/statsdata/translations'),
                27 => (\dirname(__DIR__, 4).'/modules/ps_accounts/translations'),
                28 => (\dirname(__DIR__, 4).'/modules/ps_mbo/translations'),
                29 => (\dirname(__DIR__, 4).'/modules/psxdesign/translations'),
                30 => (\dirname(__DIR__, 4).'/modules/statssales/translations'),
                31 => (\dirname(__DIR__, 4).'/modules/statssearch/translations'),
                32 => (\dirname(__DIR__, 4).'/modules/statsbestcategories/translations'),
                33 => (\dirname(__DIR__, 4).'/modules/gamification/translations'),
                34 => (\dirname(__DIR__, 4).'/modules/gridhtml/translations'),
                35 => (\dirname(__DIR__, 4).'/modules/ps_viewedproduct/translations'),
                36 => (\dirname(__DIR__, 4).'/modules/ps_cashondelivery/translations'),
                37 => (\dirname(__DIR__, 4).'/modules/statsbestsuppliers/translations'),
                38 => (\dirname(__DIR__, 4).'/modules/klaviyopsautomation/translations'),
                39 => (\dirname(__DIR__, 4).'/modules/psxmarketingwithgoogle/translations'),
                40 => (\dirname(__DIR__, 4).'/modules/statsforecast/translations'),
                41 => (\dirname(__DIR__, 4).'/modules/ps_brandlist/translations'),
                42 => (\dirname(__DIR__, 4).'/modules/statsbestproducts/translations'),
                43 => (\dirname(__DIR__, 4).'/modules/ps_facebook/translations'),
                44 => (\dirname(__DIR__, 4).'/modules/ps_themecusto/translations'),
                45 => (\dirname(__DIR__, 4).'/modules/statsregistrations/translations'),
                46 => (\dirname(__DIR__, 4).'/modules/statsnewsletter/translations'),
                47 => (\dirname(__DIR__, 4).'/modules/statsbestcustomers/translations'),
                48 => (\dirname(__DIR__, 4).'/modules/psshipping/translations'),
                49 => (\dirname(__DIR__, 4).'/modules/ps_checkout/translations'),
                50 => (\dirname(__DIR__, 4).'/modules/statscatalog/translations'),
                51 => (\dirname(__DIR__, 4).'/modules/dashgoals/translations'),
                52 => (\dirname(__DIR__, 4).'/modules/psassistant/translations'),
                53 => (\dirname(__DIR__, 4).'/modules/statsproduct/translations'),
                54 => (\dirname(__DIR__, 4).'/modules/dashtrends/translations'),
                55 => (\dirname(__DIR__, 4).'/modules/dashproducts/translations'),
                ...
                58 => (\dirname(__DIR__, 4).'/modules/ps_emailalerts/translations'),
                59 => (\dirname(__DIR__, 4).'/modules/statscheckup/translations'),
                60 => (\dirname(__DIR__, 4).'/modules/dashactivity/translations'),
                61 => (\dirname(__DIR__, 4).'/modules/ps_supplierlist/translations'),
                62 => (\dirname(__DIR__, 4).'/modules/ps_edition_basic/translations'),
                63 => (\dirname(__DIR__, 4).'/modules/ps_crossselling/translations'),
                64 => (\dirname(__DIR__, 4).'/modules/ps_checkpayment/translations'),
                65 => (\dirname(__DIR__, 4).'/modules/ps_metrics/translations'),
                66 => (\dirname(__DIR__, 4).'/modules/ps_googleanalytics/translations'),
                67 => (\dirname(__DIR__, 4).'/modules/statsbestvouchers/translations'),
                68 => (\dirname(__DIR__, 4).'/modules/statsbestmanufacturers/translations'),
                69 => (\dirname(__DIR__, 4).'/modules/gsitemap/translations'),
                70 => (\dirname(__DIR__, 4).'/modules/statsstock/translations'),
            ],
            ...
            'kernel.secret' => 'fDxEUwhOFv4KmcbIkSqwjA6Cp1hObVGNXeVXYxMtcUX9v6GHIPRKZveiYTBvjuVo',
