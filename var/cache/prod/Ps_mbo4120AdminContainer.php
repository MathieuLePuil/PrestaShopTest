 ...
 * @final
 */
class Ps_mbo4120AdminContainer extends Container
{
    private $parameters = [];
    ...
    public function __construct()
    {
        ...
        $this->methodMap = [
            ...
            'mbo.ps_eventbus.installer' => 'getMbo_PsEventbus_InstallerService',
        ];
        $this->aliases = [
    ...
    {
        return $this->services['mbo.doctrine.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('', 0, '/Users/mathieulp/Desktop/AltumWeb/PrestaShop/var/cache/prod/%/ps_mbo');
    }
    ...
    {
        return $this->services['mbo.doctrine.cache.provider'] = new \Symfony\Component\Cache\DoctrineProvider(($this->services['mbo.doctrine.cache.adapter'] ?? ($this->services['mbo.doctrine.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('', 0, '/Users/mathieulp/Desktop/AltumWeb/PrestaShop/var/cache/prod/%/ps_mbo'))));
    }
    ...
    /**
     * Gets the public 'mbo.ps_eventbus.installer' shared service.
     *
     * @return \PrestaShop\Module\Mbo\Service\ModuleInstaller
     */
    protected function getMbo_PsEventbus_InstallerService()
    {
    ...
    {
        return [
            'ps_cache_dir' => '/Users/mathieulp/Desktop/AltumWeb/PrestaShop/var/cache/prod/',
        ];
    }
}
