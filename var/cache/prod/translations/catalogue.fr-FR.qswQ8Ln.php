...
$catalogue = new MessageCatalogue('fr-FR', array (
  ...
  array (
    'https://prestashop.com/prestashop-account-terms-conditions/' => 'https://prestashop.fr/prestashop-account-cgu/',
    'https://prestashop.com/prestashop-account-privacy/' => 'https://prestashop.fr/prestashop-account-politique-de-confidentialite/',
    'Enable Back Office access' => 'Activer l\'accès Back Office',
    'Save' => 'Sauvegarder',
    'Configuration updated' => 'Configuration mise à jour',
    'By activating this option, we may process your personal data in order to provide our support services. Information about this data processing can be found in our' => 'En activant cette option, nous serons amenés à traiter vos données personnelles afin d\'assurer nos prestations de support. Les informations relatives à ce traitement de données sont disponibles dans nos',
    'PrestaShop Account terms and conditions' => 'conditions générales PrestaShop Account',
    '(see data processing agreement in the appendix).' => '(contrat de sous-traitance des données en annexe).',
    'Learn more about your data and your rights.' => 'En savoir plus sur vos données et vos droits.',
  ),
